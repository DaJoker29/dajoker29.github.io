...
<body>
    <section id="vitals">
        <span id="name">Dewitt Buckingham</span>
        <span id="location">Manteca, California</span>
        <span id="phone"><a href="tel:+12097409063">209.740.9063</a></span>
        <span id="email"><a href="mailto:captain@zerodaedalus.net">captain@zerodaedalus.net</a></span>
    </section>
